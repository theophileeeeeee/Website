...
if (savedTheme) {
  root.setAttribute('data-theme', savedTheme); // applique le thème dès le chargement
} else {
  root.setAttribute('data-theme', 'dark'); // par défaut si rien n'est enregistré
}
...
if(toggle){
  toggle.addEventListener('click', () => {
    ...
    localStorage.setItem('theme', current); // mémorisation
    updateSocialIcons();
  });
}
...
// Fermer menu avec Escape ou en resize
